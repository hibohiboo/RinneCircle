...
- 惨劇 RoopeR 要素として、主人公のできることは手札を選んで 1 枚出すのみ
- ソロジャーナル要素として、任意のタイミングで、主人公の心情などを日記に残すことができる
- ループもの要素として、以前のループの経験により手札が増える

## Done

### その他

-[x] stepci に 文字列パラメータの先頭が数値だと数値として認識されてしまうバグがあることを報告したい
